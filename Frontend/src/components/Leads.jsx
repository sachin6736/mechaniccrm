...
import { Users, ChevronUp, ChevronDown, PlusCircle } from 'lucide-react';
...
const Leads = () => {
  ...
  const fetchLeads = async (pageNum, disposition = filterDisposition, sort = sortField, order = sortOrder) => {
    try {
      setLoading(true);
  ...
  const handleSort = (field) => {
    ...
    setPage(1);
    fetchLeads(1, filterDisposition, field, newSortOrder);
  };
  ...
  const handleFilterChange = (e) => {
    ...
    setPage(1);
    fetchLeads(1, newDisposition, sortField, sortOrder);
  };
